...
export class RoadmapSectionComponent {
  phases = [
    ...
    },
    {
      ...
      desc: 'Developing localized language models that respect cultural nuance and linguistic diversity.',
      highlight: false,
    },
    {
      id: '03',
      title: 'Industrial AI Scaling',
      desc: 'Direct integration of lab-born products into Fortune 500 supply chains and operations.',
      highlight: false,
    },
    {
      id: '04',
      title: 'Global Lab Network',
      desc: 'Unifying regional labs into a singular global decentralized intelligence network.',
      highlight: false,
    },
  ];
}
